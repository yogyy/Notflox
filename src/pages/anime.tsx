    ...
    <RootLayout
      ...
      {!session ? (
        ...
        <div className="mx-3 main">
          <div className="flex flex-col justify-center xl:flex-row max-w-7xl mx-auto gap-5">
            <section className="flex flex-col pt-16">
              ...
              <div className="w-full lg:w-[948px] mx-auto">
                <div className="w-full py-1 pt-16 mb-5 " id="similar-container">
