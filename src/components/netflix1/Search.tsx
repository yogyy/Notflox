      ...
      <div className="">
        ...
        >
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="flex min-h-full pt-10 items-start justify-center p-4 text-center">
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-[#121212] text-left align-middle shadow-xl transition-all">
                ...
                >
                  <div className="">
                    <div
                      className={'h-full overflow-y-auto transition-transform'}
                    >
                      {query.length >= 3 && (
                            ...
                            >
                              <Link
                                ...
                                className={clsx(
                                  ...
                                  'focus-within:bg-current/hover:bg-black/50 group'
                                )}
                              >
                                <p>
